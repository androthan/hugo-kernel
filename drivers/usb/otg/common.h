...
#ifdef BATTERY_DEBUG
#define dprintk(fmt, ...) printk(KERN_CRIT "[BM] " fmt, ## __VA_ARGS__)
#else
...
#define CHARGE_STOP_TEMPERATURE_MAX     	60
#define CHARGE_RECOVER_TEMPERATURE_MAX      40 // 55
...
#define CHARGE_FULL_CURRENT 80
#define CHARGE_CUT_OFF_CURRENT 60
#endif
