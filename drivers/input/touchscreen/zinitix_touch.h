...
#define	TOUCH_USING_ISP_METHOD		1	// if you use isp mode, you must add i2c device : name = "zinitix_isp" , addr 0x50
...
// ESD Protection
#define	ZINITIX_ESD_TIMER_INTERVAL	1	//second : if 0, no use. if you have to use, 3 is recommended
