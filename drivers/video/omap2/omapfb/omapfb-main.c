...
#else
#define LOGO_MEM_BASE		(0x98000000 - 0x280000)
#endif
#define LOGO_MEM_SIZE		(480 * 320 * 4)
#elif defined( CONFIG_MACH_SAMSUNG_AALTO )
//FIXME: refer to aalto.h (Loke boot source)
...
#define LCD_HEIGHT_IN_MM		92	// height of lcd in mm
#define LCD_WIDTH_IN_MM			55	// width of lcd in mm
#endif
