...
/*     sensor                                                               */
/*--------------------------------------------------------------------------*/
#define CAMIF_CONFIGURE_FILE_LSI                "/mnt/sdcard/external_sd/reg_val_sr030pc30.txt"
...
static const u32 sr030pc30_dataline[] = 
{
0xef00,
0x0a01,  // s/w reset
0x0401,
...
static const u32 sr030pc30_dataline_stop[] = 
{	
0xef00,
0xcb00,
};
...
//==========================================================
//	CAMERA INITIAL for WIFI CALL (QIK) Preview 15 Fixed Frame (VGA SETTING)
//==========================================================
...
0x9101, //EXP Fix 15.02 fps
0x9284, 
0x932f, 

0x988c, 
0x9923, 
0x9c08, //EXP Limit 666.67 fps 
0x9dca, 
0x9e00, //EXP Unit 
0x9ffa,  
0xb014, 
...
0x8420, //1c 20 1E / // RMIN Default : 20
...
static unsigned short SR030pc30_init_vt2_reg[] = {			 
0x0300, 
0x01f1, 
0x01f3, 
0x01f1, 
...
0x0300,
0x1000,
0x11b3, //On Var Frame - None : 90, X Flip : 91, Y Flip :
0x1224,//PCLK Inversion
0x2000,
0x2106,
0x2200,
...
0x0300,
0x11b3, //3 Bad frame skip, Fixed disable 
0x01f0,
};
...
0x0300, //Page 0
0x1000, //no change(v sync type)
0x11b7, //Fixed On(fixed frame enable : BIT 2)
0x1204, //00,
0x2000, 
0x2106, 
0x2200, 
...
static unsigned short SR030pc30_preview_640x480[] = {
0x0300,
0x01f1,
0x1000,
0x01f0,
...
static unsigned short SR030pc30_preview_320x240[] = { 
0x0300,
0x01f1,
0x1010,
0x01f0,
...
static unsigned short SR030pc30_FLIP_NONE_640x480[] = { 
0x0300,
0x1190,		//90,	 //B[1:0] 00: Flip None, 01:X Flip, 02:Y Flip, 03:XY Flip
0xffff,
};

static unsigned short SR030pc30_FLIP_MIRROR_640x480[] = { 
0x0300,
0x1193,		//93,  //B[1:0] 00: Flip None, 01:X Flip, 02:Y Flip, 03:XY Flip
0xffff,
};
...
0x8120, 
0x8248, 
0x8354, //66 RMAX Default : 50 
0x8420, //28 26 RMIN Default : 20
0x8552, //58 5a BMAX Default : 50
0x8620, //20 BMIN Default : 20
0x10fb,
};
...
0x0300, //Page 0
0x1000, //no change(v sync type)
0x11b5, //Fixed On(fixed frame enable : BIT 2)
0x1204, //00,
0x2000, 
0x2106, 
0x2200, 
