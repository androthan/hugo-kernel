 ...
 *
 * Register definitions for the SYS LSI S5K5BBGX CameraChip.
 *
 ...
 *****************************************************
 *****************************************************
 * modules/camera/S5K5BBGX.h
 *
 * S5K5BBGX sensor driver header file
 *
...
#define CAM_S5K5BBGX_DBG_MSG            0
#define CAM_S5K5BBGX_I2C_DBG_MSG        0
#define CAM_S5K5BBGX_TUNE               0
#define S5K5BBGX_DRIVER_NAME            "s5k5bbgx"
#define S5K5BBGX_MOD_NAME               "S5K5BBGX: "

#define IN_IMAGE                     0
#define IN_SDCARD                    1

#define S5K5BBGX_FIRMWARE_F2U_MMC_NAME   "/mnt/sdcard/external_sd/S5K5BBGXF00.bin" //F2U
#define S5K5BBGX_FIRMWARE_F3U_MMC_NAME   "/mnt/sdcard/external_sd/S5K5BBGXF01.bin" //F3U
#define S5K5BBGX_FIRMWARE_F2_MMC_NAME    "/mnt/sdcard/external_sd/S5K5BBGXF02.bin" //F2
#define S5K5BBGX_FIRMWARE_F3_MMC_NAME    "/mnt/sdcard/external_sd/S5K5BBGXF03.bin" //F3

#define S5K5BBGX_FIRMWARE_F2U_NAME       "/system/firmware/S5K5BBGXF00.bin" //F2U
#define S5K5BBGX_FIRMWARE_F3U_NAME       "/system/firmware/S5K5BBGXF01.bin" //F3U
#define S5K5BBGX_FIRMWARE_F2_NAME        "/system/firmware/S5K5BBGXF02.bin" //F2
#define S5K5BBGX_FIRMWARE_F3_NAME        "/system/firmware/S5K5BBGXF03.bin" //F3

#define S5K5BBGX_NOT_FW_UPDATE_OPERATION 0xFF
...
#define S5K5BBGX_FW_MINOR_VERSION    0x0F
#define S5K5BBGX_FW_MAJOR_VERSION    0x05
#define S5K5BBGX_PRM_MINOR_VERSION   0x38
#define S5K5BBGX_PRM_MAJOR_VERSION   0x08

#define S5K5BBGX_THUMBNAIL_OFFSET    0x271000
#define S5K5BBGX_YUV_OFFSET          0x280A00

#define S5K5BBGX_I2C_ADDR          0x5a>>1  //5bb
//#define S5K5BBGX_I2C_ADDR          0x78>>1  // 5bb
//#define S5K5BBGX_I2C_ADDR            0x40>>1 //LYG sr200pc10
#define S5K5BBGX_I2C_RETRY           10
#define S5K5BBGX_XCLK                24000000     //24000000    // 27000000   //have to be fixed//24000000      //have to be fixed
...
enum s5k5bbgx_op_mode {
	S5K5BBGX_MODE_VIDEO = 0,
	S5K5BBGX_MODE_IMAGE = 1,
};
...
/**
 * struct s5k5bbgx_platform_data - platform data values and access functions
...
struct s5k5bbgx_version {
	unsigned int major;
	unsigned int minor;
};

struct s5k5bbgx_date_info {
	unsigned int year;
	unsigned int month;
	unsigned int date;
};

struct s5k5bbgx_sensor_maker{
	unsigned int maker;
	unsigned int optical;
};

struct s5k5bbgx_version_af{
	unsigned int low;
	unsigned int high;
};

struct s5k5bbgx_gamma{
	unsigned int rg_low;
...
/**   
 * struct s5k5bbgx_sensor - main structure for storage of sensor information
 ...
 * @scaler:
 * @ver: s5k5bbgx chip version
 * @fps: frames per second value   
 */
struct s5k5bbgx_sensor {
	const struct s5k5bbgx_platform_data *pdata;
	struct mutex s5k5bbgx_previewlock;
	struct mutex s5k5bbgx_capturelock;
	struct mutex s5k5bbgx_setlock;
	struct v4l2_int_device *v4l2_int_device;
	struct i2c_client *i2c_client;
	struct v4l2_pix_format pix;
	struct v4l2_fract timeperframe;
	struct s5k5bbgx_version fw;
	struct s5k5bbgx_version prm;
	struct s5k5bbgx_date_info dateinfo;  
	struct s5k5bbgx_sensor_maker sensor_info;
	struct s5k5bbgx_version_af af_info;
	struct s5k5bbgx_gamma gamma;  
	struct s5k5bbgx_position position;
	int sensor_version;
	unsigned int fw_dump_size;  
	struct s5k5bbgx_version main_sw_fw;
	struct s5k5bbgx_version main_sw_prm;
	struct s5k5bbgx_date_info main_sw_dateinfo;  
	int check_dataline;  
	u32 state;
	u8 mode;
	u8 fps;
...
/* State */
#define S5K5BBGX_STATE_PREVIEW	  0x0000	/*  preview state */
#define S5K5BBGX_STATE_CAPTURE	  0x0001	/*  capture state */
#define S5K5BBGX_STATE_INVALID	  0x0002	/*  invalid state */

/* Mode */
#define S5K5BBGX_MODE_CAMERA     1
#define S5K5BBGX_MODE_CAMCORDER  2
#define S5K5BBGX_MODE_VT         3

/* Preview Size */
#define S5K5BBGX_PREVIEW_SIZE_1280_720   0
#define S5K5BBGX_PREVIEW_SIZE_800_480    1
#define S5K5BBGX_PREVIEW_SIZE_720_480    2
#define S5K5BBGX_PREVIEW_SIZE_640_480    3
#define S5K5BBGX_PREVIEW_SIZE_400_240    4
#define S5K5BBGX_PREVIEW_SIZE_320_240    5
#define S5K5BBGX_PREVIEW_SIZE_352_288    6
#define S5K5BBGX_PREVIEW_SIZE_200_120    7
#define S5K5BBGX_PREVIEW_SIZE_176_144    8
#define S5K5BBGX_PREVIEW_SIZE_144_176    9
#define S5K5BBGX_PREVIEW_SIZE_160_120    10

/* Image Size */
#define S5K5BBGX_IMAGE_SIZE_3264_2448  0
#define S5K5BBGX_IMAGE_SIZE_2560_1920  1
#define S5K5BBGX_IMAGE_SIZE_2560_1536  2
#define S5K5BBGX_IMAGE_SIZE_2560_1440  3
#define S5K5BBGX_IMAGE_SIZE_2048_1536  4
#define S5K5BBGX_IMAGE_SIZE_2048_1232  5
#define S5K5BBGX_IMAGE_SIZE_1920_1080  6
#define S5K5BBGX_IMAGE_SIZE_1600_1200  7
#define S5K5BBGX_IMAGE_SIZE_1600_960   8
#define S5K5BBGX_IMAGE_SIZE_1280_960   9
#define S5K5BBGX_IMAGE_SIZE_1280_768   10
#define S5K5BBGX_IMAGE_SIZE_1280_720   11
#define S5K5BBGX_IMAGE_SIZE_1024_768   12
#define S5K5BBGX_IMAGE_SIZE_800_600    13
#define S5K5BBGX_IMAGE_SIZE_800_480    14
#define S5K5BBGX_IMAGE_SIZE_720_480    15
#define S5K5BBGX_IMAGE_SIZE_640_480    16
#define S5K5BBGX_IMAGE_SIZE_400_240    17
#define S5K5BBGX_IMAGE_SIZE_352_288    18
#define S5K5BBGX_IMAGE_SIZE_320_240    19
#define S5K5BBGX_IMAGE_SIZE_200_120    20
#define S5K5BBGX_IMAGE_SIZE_176_144    21
#define S5K5BBGX_IMAGE_SIZE_160_120    22

/* Image Effect */
#define S5K5BBGX_EFFECT_OFF      1
#define S5K5BBGX_EFFECT_SHARPEN  2
#define S5K5BBGX_EFFECT_PURPLE   3
#define S5K5BBGX_EFFECT_NEGATIVE 4
#define S5K5BBGX_EFFECT_SEPIA    5
#define S5K5BBGX_EFFECT_AQUA     6
#define S5K5BBGX_EFFECT_GREEN    7
#define S5K5BBGX_EFFECT_BLUE     8
#define S5K5BBGX_EFFECT_PINK     9
#define S5K5BBGX_EFFECT_YELLOW   10
#define S5K5BBGX_EFFECT_GREY     11
#define S5K5BBGX_EFFECT_RED      12
#define S5K5BBGX_EFFECT_BW       13
#define S5K5BBGX_EFFECT_ANTIQUE  14

/* ISO */
#define S5K5BBGX_ISO_AUTO        1
#define S5K5BBGX_ISO_50          2
#define S5K5BBGX_ISO_100         3
#define S5K5BBGX_ISO_200         4
#define S5K5BBGX_ISO_400         5
#define S5K5BBGX_ISO_800         6
#define S5K5BBGX_ISO_1600        7

/* Photometry */
#define S5K5BBGX_PHOTOMETRY_MATRIX   1
#define S5K5BBGX_PHOTOMETRY_CENTER   2
#define S5K5BBGX_PHOTOMETRY_SPOT     3

/* EV */
#define S5K5BBGX_EV_MINUS_2P0    1
#define S5K5BBGX_EV_MINUS_1P5    2
#define S5K5BBGX_EV_MINUS_1P0    3
#define S5K5BBGX_EV_MINUS_0P5    4
#define S5K5BBGX_EV_DEFAULT      5
#define S5K5BBGX_EV_PLUS_0P5     6
#define S5K5BBGX_EV_PLUS_1P0     7
#define S5K5BBGX_EV_PLUS_1P5     8
#define S5K5BBGX_EV_PLUS_2P0     9

/* WDR */
#define S5K5BBGX_WDR_OFF         1
#define S5K5BBGX_WDR_ON          2
#define S5K5BBGX_WDR_AUTO        3

/* Contrast */
#define S5K5BBGX_CONTRAST_MINUS_3      1
#define S5K5BBGX_CONTRAST_MINUS_2      2
#define S5K5BBGX_CONTRAST_MINUS_1      3
#define S5K5BBGX_CONTRAST_DEFAULT      4
#define S5K5BBGX_CONTRAST_PLUS_1       5
#define S5K5BBGX_CONTRAST_PLUS_2       6
#define S5K5BBGX_CONTRAST_PLUS_3       7

/* Saturation */
#define S5K5BBGX_SATURATION_MINUS_3    1
#define S5K5BBGX_SATURATION_MINUS_2    2
#define S5K5BBGX_SATURATION_MINUS_1    3
#define S5K5BBGX_SATURATION_DEFAULT    4
#define S5K5BBGX_SATURATION_PLUS_1     5
#define S5K5BBGX_SATURATION_PLUS_2     6
#define S5K5BBGX_SATURATION_PLUS_3     7

/* Sharpness */
#define S5K5BBGX_SHARPNESS_MINUS_3     1
#define S5K5BBGX_SHARPNESS_MINUS_2     2
#define S5K5BBGX_SHARPNESS_MINUS_1     3
#define S5K5BBGX_SHARPNESS_DEFAULT     4
#define S5K5BBGX_SHARPNESS_PLUS_1      5
#define S5K5BBGX_SHARPNESS_PLUS_2      6
#define S5K5BBGX_SHARPNESS_PLUS_3      7

/* White Balance */
#define S5K5BBGX_WB_AUTO               1
#define S5K5BBGX_WB_DAYLIGHT           2
#define S5K5BBGX_WB_CLOUDY             3
#define S5K5BBGX_WB_INCANDESCENT       4
#define S5K5BBGX_WB_FLUORESCENT        5

/* Image Stabilization */
#define S5K5BBGX_ISC_STILL_OFF         1
#define S5K5BBGX_ISC_STILL_ON          2
#define S5K5BBGX_ISC_STILL_AUTO        3
#define S5K5BBGX_ISC_MOVIE_ON          4

/* Scene Mode */
#define S5K5BBGX_SCENE_OFF             1
#define S5K5BBGX_SCENE_ASD             2
#define S5K5BBGX_SCENE_SUNSET          3
#define S5K5BBGX_SCENE_DAWN            4
#define S5K5BBGX_SCENE_CANDLELIGHT     5
#define S5K5BBGX_SCENE_BEACH_SNOW      6
#define S5K5BBGX_SCENE_AGAINST_LIGHT   7
#define S5K5BBGX_SCENE_TEXT            8
#define S5K5BBGX_SCENE_NIGHTSHOT       9
#define S5K5BBGX_SCENE_LANDSCAPE       10
#define S5K5BBGX_SCENE_FIREWORKS       11
#define S5K5BBGX_SCENE_PORTRAIT        12
#define S5K5BBGX_SCENE_FALLCOLOR       13
#define S5K5BBGX_SCENE_INDOORS         14
#define S5K5BBGX_SCENE_SPORTS          15

/* Auto Exposure & Auto White Balance */
#define S5K5BBGX_AE_UNLOCK_AWB_UNLOCK  0
#define S5K5BBGX_AE_LOCK_AWB_LOCK      1
#define S5K5BBGX_AE_LOCK_AWB_UNLOCK    2
#define S5K5BBGX_AE_UNLOCK_AWB_LOCK    3

/* Anti-Shake */
#define S5K5BBGX_ANTI_SHAKE_OFF        1
#define S5K5BBGX_ANTI_SHAKE_ON         2

/* Flash Setting */
#define S5K5BBGX_FLASH_CAPTURE_OFF     1
#define S5K5BBGX_FLASH_CAPTURE_ON      2
#define S5K5BBGX_FLASH_CAPTURE_AUTO    3

#define S5K5BBGX_FLASH_MOVIE_OFF       1
#define S5K5BBGX_FLASH_MOVIE_ON        2

/* Focus Mode */
//#define FEATURE_TOUCH_AF
#define S5K5BBGX_AF_INIT_NORMAL        1
#define S5K5BBGX_AF_INIT_MACRO         2
#define S5K5BBGX_AF_INIT_FACE          3
#define S5K5BBGX_AF_INIT_FACE_NOLINE   4
#define S5K5BBGX_AF_INIT_CONTINUOUS 	5

/* Focust start/stop */
#define S5K5BBGX_AF_START              1
#define S5K5BBGX_AF_STOP               2

/* Auto Focus Status */
#define S5K5BBGX_AF_STATUS_PROGRESS    1
#define S5K5BBGX_AF_STATUS_SUCCESS     2
#define S5K5BBGX_AF_STATUS_FAIL        3

/* Digital Zoom */
#define S5K5BBGX_ZOOM_DEFAULT          0
#define S5K5BBGX_ZOOM_1P00X            1
#define S5K5BBGX_ZOOM_1P25X            2
#define S5K5BBGX_ZOOM_1P50X            3
#define S5K5BBGX_ZOOM_1P75X            4
#define S5K5BBGX_ZOOM_2P00X            5
#define S5K5BBGX_ZOOM_2P25X            6
#define S5K5BBGX_ZOOM_2P50X            7
#define S5K5BBGX_ZOOM_2P75X            8
#define S5K5BBGX_ZOOM_3P00X            9
#define S5K5BBGX_ZOOM_3P25X            10
#define S5K5BBGX_ZOOM_3P50X            11
#define S5K5BBGX_ZOOM_3P75X            12
#define S5K5BBGX_ZOOM_4P00X            13

/* JPEG Quality */
#define S5K5BBGX_JPEG_SUPERFINE        1
#define S5K5BBGX_JPEG_FINE             2
#define S5K5BBGX_JPEG_NORMAL           3
#define S5K5BBGX_JPEG_ECONOMY          4
...
struct s5k5bbgx_preview_size {
	unsigned int width;
	unsigned int height;
};

const static struct s5k5bbgx_preview_size s5k5bbgx_preview_sizes[] = {
	{1280,720},  
	{800,480},    
	//{800,600},    //LYG
	{720,480},   
...
struct s5k5bbgx_capture_size {
	unsigned int width;
	unsigned int height;
};

/* Image sizes */
const static struct s5k5bbgx_capture_size s5k5bbgx_image_sizes[] = {
	{3264,2448},
	{2560,1920},     
	{2560,1536},
	{2560,1440},
...
0x00287000,
0x002A040E,
0x0F120003, //STBY TnP enable setting STBY TnP enable setting [0] bit  STBY enable,[1] bit  STBY   ?TnP   on/off bit
0xFFFE000A,
...
0xFFFE000A,
// FILESAVE('E:\0_\02_5BB\0206\frame_.jpg',5)
// Backup Register
0x002A0416,
...
0x0F122710, //2BF2 //35B6 //3A98 //445C //REG_TC_IPRM_MinOutRate4KHz_0
0x0F122710, //2BF2 //35B6 //3A98 //445C //REG_TC_IPRM_MaxOutRate4KHz_0
...
0x0F122710, //2BF2  //35B6 //3A98 //222E	//REG_0TC_PCFG_usMaxOut4KHzRate 				2	70000176
0x0F122710, //2BF2  //35B6 //3A98 //222E	//REG_0TC_PCFG_usMinOut4KHzRate 				2	70000178
0x0F120052, //0042	//0042	//REG_0TC_PCFG_PVIMask							2	7000017A
0x0F120010, //0010	//0010	//REG_0TC_PCFG_OIFMask							2	7000017C
0x0F120000, //0000	//0001	//REG_0TC_PCFG_uClockInd						2	7000017E
...
#if defined(CONFIG_HUGO_USA) || defined(CONFIG_HUGO_KOR)
0x0F12029A, //bb	//lyg //60Hz	//REG_0TC_PCFG_usMinFrTimeMsecMult10			2	70000186  max frame time : 30fps:014D 15fps:029a 7.5fps:0535 3.75fps:a6a
#else
...
0x0F120003, // JinoKang For PV Camera//0000	//0001	//REG_0TC_PCFG_uPrevMirror						2	70000192
0x0F120003, // JinoKang For PV Camera//0000	//0001	//REG_0TC_PCFG_uCaptureMirror					2	70000194
...
0x0F122710, //2BF2 //35B6 //3A98 //REG_0TC_CCFG_usMaxOut4KHzRate 				2	70000240
0x0F122710, //2BF2 //35B6 //3A98 //REG_0TC_CCFG_usMinOut4KHzRate 				2	70000242
0x0F120052, //REG_0TC_CCFG_PVIMask							2	70000244
0x0F120000, //REG_0TC_CCFG_OIFMask							2	70000246
0x0F120000, //REG_0TC_CCFG_uClockInd						2	70000248
...
0x002A0CC0,
#if defined(CONFIG_HUGO_USA) || defined(CONFIG_HUGO_KOR)
0x0F120001, //AFC_Default60Hz	01:60hz 00:50Hz - USA only
...
0x00287000,
0x002A10B8, 
0x0F120300,    //bp_uMaxBrightnessFactor	(Max π‡±‚ ¡ı∞°)
0x002A10BE,
0x0F120300,    //bp_uMinBrightnessFactor (Min π‡±‚ ¡ı∞°)
...
static const  u32 mode_preview_800x480[] = {
0xFCFCD000,
0x00287000,

0x002A0170,                                                            
0x0F120320, //0280	//REG_1TC_PCFG_usWidth							2	70000198  640
0x0F1201E6, //01E0	//REG_1TC_PCFG_usHeight 						2	7000019A  480
...
0x002A03C4,
0x0F120002, //#lt_uMaxExp1
0x002A03C8,
0x0F120508, //#lt_uMaxExp2
0x002A03CC,
0x0F121A0A, //#lt_uMaxExp3
0x002A03D0,
0x0F123415, //#lt_uMaxExp4
0x0F120000, //#lt_uMaxExp4

0x002A03D4,
0x0F120002, //#lt_uCapMaxExp1
0x002A03D8,
0x0F120508, //#lt_uCapMaxExp2
0x002A03DC,
0x0F121A0A, //#lt_uCapMaxExp3
0x002A03E0,
0x0F123415, //#lt_uCapMaxExp4
0x0F120000, //#lt_uCapMaxExp4

0x002A03E4,
0x0F120200, //#lt_uMaxAnGain1  //01C0:14ea 0230:10ea
0x0F120200, //#lt_uMaxAnGain2  //01D0:21ea 0260:18ea
0x0F120200, //#lt_uMaxAnGain3
0x0F120200, //#lt_uMaxAnGain4
0x0F120200, //#lt_uMaxDigGain
0x0F128000, //#lt_uMaxTotGain  Total-gain is limited by #lt_uMaxTotGain

0x0F120200, //#lt_uCapMaxAnGain1  //01C0:14ea 0230:10ea
0x0F120200, //#lt_uCapMaxAnGain2  //01D0:21ea 0260:18ea
...
0x0F120260,		//REG_SF_USER_IsoVal
0x0F120001,		//REG_SF_USER_IsoChanged

//Saturation - Sharp
0x002A012E,
0x0F120010,		//REG_TC_UserSaturation
0x0F120004,		//REG_TC_UserSharpBlur
...
0x0F120535, //REG_0TC_PCFG_usMaxFrTimeMsecMult10
#if defined(CONFIG_HUGO_USA) || defined(CONFIG_HUGO_KOR)
0x0F12029A,	//lyg //60Hz	//REG_0TC_PCFG_usMinFrTimeMsecMult10			2	70000186  max frame time : 30fps:014D 15fps:029a 7.5fps:0535 3.75fps:a6a
#else
0x0F1202BC,	//50Hz	//REG_0TC_PCFG_usMinFrTimeMsecMult10			2	70000186  max frame time : 30fps:014D 15fps:029a 7.5fps:0535 3.75fps:a6a
#endif
...
0x002A10CE,
0x0F120000, //0000 //ae_WeightTbl_16[0]							2	7000104E
0x0F120000, //0000 //ae_WeightTbl_16[1]							2	70001050
0x0F120000, //0000 //ae_WeightTbl_16[2]							2	70001052
0x0F120000, //0000 //ae_WeightTbl_16[3]
                  
0x0F120000, //0000 //ae_WeightTbl_16[4]							2	70001056
0x0F120000, //0000 //ae_WeightTbl_16[5]							2	70001058
0x0F120000, //0000 //ae_WeightTbl_16[6]							2	7000105A
0x0F120000, //0000 //ae_WeightTbl_16[7]							2	7000105C
                  
0x0F120000, //0000 //ae_WeightTbl_16[8]							2	7000105E
0x0F120101, //0101 //ae_WeightTbl_16[9]							2	70001060
0x0F120101, //0101 //ae_WeightTbl_16[10]							2	70001062
0x0F120000, //0000 //ae_WeightTbl_16[11]							2	70001064
                  
0x0F120000, //0000 //ae_WeightTbl_16[12]							2	70001066
0x0F120F01, //0F01 //ae_WeightTbl_16[13]							2	70001068
0x0F12010F, //010F //ae_WeightTbl_16[14]							2	7000106A
0x0F120000, //0000 //ae_WeightTbl_16[15]							2	7000106C
                  
0x0F120000, //0000 //ae_WeightTbl_16[16]							2	7000106E
0x0F120F01, //0F01 //ae_WeightTbl_16[17]							2	70001070
0x0F12010F, //010F //ae_WeightTbl_16[18]							2	70001072
0x0F120000, //0000 //ae_WeightTbl_16[19]							2	70001074
                  
0x0F120000, //0000 //ae_WeightTbl_16[20]							2	70001076
0x0F120101, //0101 //ae_WeightTbl_16[21]							2	70001078
0x0F120101, //0101 //ae_WeightTbl_16[22]							2	7000107A
0x0F120000, //0000 //ae_WeightTbl_16[23]							2	7000107C
                  
0x0F120000, //0000 //ae_WeightTbl_16[24]							2	7000107E
0x0F120000, //0000 //ae_WeightTbl_16[25]							2	70001080
0x0F120000, //0000 //ae_WeightTbl_16[26]							2	70001082
0x0F120000, //0000 //ae_WeightTbl_16[27]							2	70001084
                  
0x0F120000, //0000 //ae_WeightTbl_16[28]							2	70001086
0x0F120000, //0000 //ae_WeightTbl_16[29]							2	70001088
0x0F120000, //0000 //ae_WeightTbl_16[30]							2	7000108A
0x0F120000, //0000 //ae_WeightTbl_16[31]							2	7000108C
