...
static int ce147_probe(struct i2c_client *client, const struct i2c_device_id *device)
{
	...
	printk("CE147 : YGLEE start OK ce147_probe is called...\n");

	if(hw_revision<0x01){
		printk("CE147 : YGLEE start OK sr200pc10_sensor_init is return...\n");
		return -1;
	}
...
static int __init ce147_sensor_init(void)
{
	...
	printk("CE147 : start OK ce147_sensor_init is called.hw_revision=0x%02x..\n",hw_revision);
	if(hw_revision<0x01){
		printk("CE147 : start OK ce147_sensor_init is return...\n");
		return -1;
	}
