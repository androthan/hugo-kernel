...
#define FMRADIO_VOL_30

/* Change TSP scan delay during channel scan for AALTO(YP-GS1) project */
#define FMRADIO_TSP_DELAY_CONTROL

/* Change Wait function for preventing deadlock by miscatching interrupt in HUGO(YP-GI1) project. kh76.kim, 2012.01.13. */
#define FMRADIO_WAIT_TIMEOUT
