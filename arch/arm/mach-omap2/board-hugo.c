...
static struct omap_volt_pmic_info omap_pmic_mpu = {	/* and iva */
	...
	.vp_vlimitto_vddmin = 0x19,		/* from Latona @327812 */
...
static void __init get_board_hw_rev(void)
{
...
#if 0
	ret = gpio_request(OMAP_GPIO_HW_REV3, "HW_REV3");
	if (ret < 0) {
		printk("fail to get gpio : %d, res : %d\n", OMAP_GPIO_HW_REV3,
		       ret);
		return;
	...
	hw_revision |= (gpio_get_value(OMAP_GPIO_HW_REV3) << 3);
	gpio_free(OMAP_GPIO_HW_REV3);
#endif

	switch (hw_revision) {
	case 0x0:
		printk("   Hugo HW Revision : REV 0.0 \n");
		break;
	case 0x1:
		printk("   Hugo HW Revision : REV 0.1 (2011-10-24) \n");
		break;
	case 0x2:
		printk("   Hugo HW Revision : REV 0.2 (2011-11-14) \n");
		break;
	case 0x3:
		printk("   Hugo HW Revision : REV 0.3 (2011-11-26) \n");
		break;
	case 0x4:
		printk("   Hugo HW Revision : REV 0.5 (2011-12-20) \n");
		break;
	case 0x5:
		printk("   Hugo HW Revision : REV 0.6 (2012-01-05) \n");
		break;
	default:
		printk("   Hugo HW Revision : UNKNOWN \n");
		break;
	}
}
