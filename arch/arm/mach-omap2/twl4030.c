...
static struct twl4030_ins __initdata sleep_on_seq[] = {
    ...
    {MSG_BROADCAST(DEV_GRP_ALL, RES_GRP_ALL, RES_TYPE_ALL, RES_TYPE2_R2,
                            RES_STATE_SLEEP), 2},
//    {MSG_SINGULAR(DEV_GRP_NULL, RES_VSIM, RES_STATE_OFF), 2},
};
...
static struct twl4030_resconfig twl4030_rconfig[] = {
    ...
    { .resource = RES_VDAC, .devgroup = DEV_GRP_P1,
        .type = 0, .type2 = 0, .remap_sleep = RES_STATE_OFF },
	...
	{ .resource = RES_VINTANA2, .devgroup = DEV_GRP_P1,
	    .type = 0, .type2 = 2, .remap_sleep = RES_STATE_OFF },   // put into OFF 
    ...
    // Reset and Control Device Group
