/*
 * linux/arch/arm/mach-omap2/mux_aalto_rev_r07.c
 *
...
//	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_LCD_EN_SET, 1)
	...
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_LED_EN, 0)
...
//	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_PDA_ACTIVE, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_MUTE_ON, 0)
...
//	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_MASSMEMORY_EN, 1)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_FUEL_SDA, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_FUEL_SCL, 0)
//	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_ALS_EN, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_CAM_VGA_RST_N, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_5M_CAM_NRST, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_CAM_CIF_NSTBY, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_TDMB_EN, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_TDMB_RST, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_TDMB_INT, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_LCD_ID1, 0)
//	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_FUEL_ALERT, 0)
//	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_TSP_EN, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_TDMB_SPI_SCLK, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_TDMB_SPI_MOSI, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_TDMB_SPI_MISO, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_TDMB_SPI_CS, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_LCD_ADC, 0)
//	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_SENSOR_EN_1, 0)
//	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_FUEL_ALERT, 0)
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_HW_REV3, 0)


	// ear mic ldo added by su26.lee
	SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_EAR_MIC_EN, 0)
 ...
 */
	...
	// 39 (N4, L, GPMC_A1, INT_TEMP_POP) // aalto hoeun
	OMAP3_MUX(GPMC_A1,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN),
	// 40 (M4, L, GPIO_35, GPS_EN) // 09/18
	OMAP3_MUX(GPMC_A2, OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT),
	// 41 (G3, L, GPIO_36, LCD_ESD_DET) // 11/04
	OMAP3_MUX(GPMC_A3, OMAP_MUX_MODE4 | OMAP_PIN_INPUT | OMAP_PIN_OFF_NONE),
	
	// 42 (G4, L, GPIO_37, GPS_LDO_EN) // 11/22 hoeun.kwon
	OMAP3_MUX(GPMC_A4, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLUP),
	// 43 (F3, L, GPIO_38, TP700) // 11/22 hoeun.kwon
	...
	// 46 (E4, H, GPIO_41, TP701) // 11/22 hoeun.kwon
	//OMAP3_MUX(GPMC_A8,	OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN | OMAP_PIN_OFF_INPUT_PULLDOWN),
	OMAP3_MUX(GPMC_A8,	OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN),
	// 47 (L3, H, GPIO_42, VOL_UP_KEY)	//aalto jmin
	OMAP3_MUX(GPMC_A9,	OMAP_MUX_MODE4 | OMAP_PIN_INPUT),
	// 48 (D4, H, GPIO_43, VOL_DOWN_KEY)	//aalto jmin
	OMAP3_MUX(GPMC_A10, OMAP_MUX_MODE4 | OMAP_PIN_INPUT),
	...
	// 57 (N2, H, GPIO_44,TDMB_EN, I/O)  //aalto hoeun
	OMAP3_MUX(GPMC_D8,	 OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 58 (P1, H, GPIO_45, TDMB_RST, I/O)  //aalto hoeun
	OMAP3_MUX(GPMC_D9,	 OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 59 (R1, H, GPIO_46,TDMB_INT, I/O) //aalto hoeun
	OMAP3_MUX(GPMC_D10,    OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 60 (U2, H, GPIO_47, LCD ADC, I/O) // 11/22 aalto hoeun
	OMAP3_MUX(GPMC_D11,    OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 61 (V3, H, GPIO_48, SENSOR_EN_1, I/O) //11/22 aalto hoeun
	OMAP3_MUX(GPMC_D12,   OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 62 (W1, H, GPMC_D13, GPMC_D13, I/O) // aalto hoeun
	OMAP3_MUX(GPMC_D13,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 63 (Y2, H, GPMC_D14, GPMC_D14, I/O) // aalto hoeun
	OMAP3_MUX(GPMC_D14,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 64 (Y1, H, GPMC_D15, GPMC_D15, I/O) // aalto hoeun
	OMAP3_MUX(GPMC_D15,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 65 (G4)
	OMAP3_MUX(GPMC_NCS0,  OMAP_MUX_MODE0 ),
	// 66 (C2, H, GPIO_52, MUTE_ON)
	OMAP3_MUX(GPMC_NCS1,  OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 67 (V8, H, GPIO_53, FUEL_ALERT, I[H], OFF[H])  // 11/22 aalto hoeun
	OMAP3_MUX(GPMC_NCS2,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 68 (U8, H, GPIO_54, IF_CON_SENSE18, I[L], OFF[L])
	OMAP3_MUX(GPMC_NCS3,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN), //egkim
	// 69 (B3, H, GPIO_55, FUEL_SCL, O) - 09/17 // aalto hoeun
	OMAP3_MUX(GPMC_NCS4,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 70 (R8, H, GPT10_PWM_EVT, VIBTONE_PWM)// aalto hoeun
	//OMAP3_MUX(GPMC_NCS5,  OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),		// Brian: when off, INPUT_PULLDOWN duplicated
	OMAP3_MUX(GPMC_NCS5,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 71 (P8, H, SAFE_MODE, N/C)
	OMAP3_MUX(GPMC_NCS6,  OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT), 
	// 72 (N8, L, GPIO_58, EN_TEMP_VDD , O[L], OFF[L]) //aalto hoeun
	...
	// 77 (G3, L, GPIO_60, GPMC_NBE0, O) // aalto hoeun
	OMAP3_MUX(GPMC_NBE0_CLE,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),//I2C_SCL_FUEL
	// 78 (U3, L, GPIO_61, GPMC_NBE1, O) //aalto hoeun
	OMAP3_MUX(GPMC_NBE1,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLUP |OMAP_PIN_OFF_INPUT_PULLUP), //I2C_SDA_FUEL
	// 79 (H1, L, SAFE_MODE, N/C) // aalto hoeun
	OMAP3_MUX(GPMC_NWP,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN), // LCD_ID1
	// 80 
	...
	// 82 (K8, H, GPMC_WAIT2, UART4_TX, O[L], OFF[L])
	OMAP3_MUX(GPMC_WAIT2,  OMAP_MUX_MODE2 | OMAP_PIN_OFF_OUTPUT_LOW),
	// 83 (J8, H, GPMC_WAIT2, UART4_RX, I[H], OFF[H] )
	...
	// 106 (H26, L, DSS_DATA18, LCD_D18, O)
	OMAP3_MUX(DSS_DATA18,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 107 (H25, L, DSS_DATA19, LCD_D19, O)
	OMAP3_MUX(DSS_DATA19,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 108 (E28, L, DSS_DATA20, LCD_D20, O)
	OMAP3_MUX(DSS_DATA20,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 109 (J26, L, DSS_DATA21, LCD_D21, O)
	OMAP3_MUX(DSS_DATA21,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 110 (AC27, L, DSS_DATA22, LCD_D22, O)	
	OMAP3_MUX(DSS_DATA22,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 111 (AC28, L, DSS_DATA23, LCD_D23, O)
	OMAP3_MUX(DSS_DATA23,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	#endif
	...
	// 118 (AF15, L, NC) //aalto hoeun
	OMAP3_MUX(CAM_D1, OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 119 (B24, L, GPIO_101, CIF_STBY, O[L], OFF[L])
	OMAP3_MUX(CAM_D2,  OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT),
	// 120 (C24, L, GPIO_102, EAR_MICBIAS_EN, O[L], OFF[L])  // aalto hoeun
	...
	// 129 (B26, L, GPIO_111, PDA_ACTIVE) // aalto hoeun
	OMAP3_MUX(CAM_XCLKB,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 130 (B20, L, SAFE_MODE, N/C)  //aalto hoeun
	OMAP3_MUX(CAM_WEN,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),	// Brian: NC
	// 131 (D25, L, SAFE_MODE, N/C) //aalto hoeun
	...
	OMAP3_MUX(CSI2_DY0,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP),
	...
	OMAP3_MUX(MCBSP2_DX,  OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLDOWN),
	...
	// 146 (K23, L, SAFE_MODE, N/C) //hoeun aalto
	OMAP3_MUX(SDMMC1_DAT4,	 OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),	// Brian: NC
	// 147 (P26, L, GPIO_127, NC) // hoeun aalto
	OMAP3_MUX(GPIO127,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// (R27, GPIO_128, NC) //hoeun aalto
	OMAP3_MUX(GPIO128,	  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	...
	// 160 (AF6, L, GPIO_140, HOME_KEY, I[H], OFF[H])
	OMAP3_MUX(MCBSP3_DX,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP3_MUX(MCBSP3_CLKX, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP | OMAP_WAKEUP_EN | OMAP_OFF_EN | OMAP_OFFOUT_EN),
	// 163 (AE5, L, GPIO_143, BAT_DET, O[L], OFF[L])
	OMAP3_MUX(MCBSP3_FSX,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLUP),
	...
	// 169 (AA9, GPIO_149, AGPS_RTS, O[L], OFF[L])  //aalto hoeun
	OMAP3_MUX(UART1_RTS,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 170 (W8, L, GPIO_150, AGPS_CTS, O[L], OFF[L])//aalto hoeun
	OMAP3_MUX(UART1_CTS,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	...
	OMAP3_MUX(MCBSP4_DX,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP),
	// 175 (M8, L, GPIO_155, AMP_SHDN, O[L], OFF[L]) // aalto hoeun
	...
	// 177 (AA21, L, GPIO_157, LCD_ID1, O[L], OFF[L])
	OMAP3_MUX(MCBSP1_FSR, OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT),
	// 178 (N18, L, GPIO_158, OMAP_GPIO_UART_SEL, O[L])
	OMAP3_MUX(MCBSP1_DX,  OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT),
	// 179 (U21, L, GPIO_159 CP_JIG_ON , I2S_DIN2, I)
	OMAP3_MUX(MCBSP1_DR,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN),//LYG
	// 180 (T21, L, GPIO_160, WLAN_EN, O[L], OFF[L])
	OMAP3_MUX(MCBSP_CLKS, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN),//20110805 LHJ
	...
	// 184 (H19, H, GPIO_164, HW_REV1, I[Z], OFF[H])
	...
	OMAP3_MUX(MCSPI1_CLK,  OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_LOW),
	// 207 (AB4, L, MCSPI1_SIMO, DISLPAY_SI, I)
	OMAP3_MUX(MCSPI1_SIMO,	OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLDOWN | OMAP_PIN_OFF_OUTPUT_LOW),
	// 208 (AA4, H, MCSPI1_SOMI, DISLPAY_SO, O)
	OMAP3_MUX(MCSPI1_SOMI,	OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLDOWN | OMAP_PIN_OFF_INPUT_PULLDOWN),
	// 209 (AC2, H, MCSPI1_CS0, DISPLAY_CS, O)
	OMAP3_MUX(MCSPI1_CS0,  OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_LOW),
	...
	OMAP3_MUX(MCSPI1_CS2,  OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),//20110805 LHJ
	// 212 (AB2, H, GPIO_177, CAM_EN3)  //aalto hoeun
	OMAP3_MUX(MCSPI1_CS3,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	
	// 213 (H9, L, GPIO_178, TDMB_SPI_SCLK, 0) // aalto hoeun
	OMAP3_MUX(MCSPI2_CLK,    OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 214 (J10, L, GPIO_179, TDMB_SPI_MOSI, 0) // aalto hoeun
	OMAP3_MUX(MCSPI2_SIMO,  OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 215 (H10, L, GPIO_180, TDMB_SI_MISO, 0) // aalto hoeun
	OMAP3_MUX(MCSPI2_SOMI, OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 216 (H11, H, GPIO_181, TDMP_SPI_CS, 0) // aalto hoeun
	OMAP3_MUX(MCSPI2_CS0,  OMAP_MUX_MODE4| OMAP_PIN_OUTPUT),
	// 217 (J11, L, GPIO_182, IPC_MRDY, 0) // aalto hoeun
	...
	// GPIO_186 (SENSOR_EN)
	OMAP3_MUX(SYS_CLKOUT2, OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT), // hugo LHJ
	...
	// 301 (AA11, H, H/W_REV3, GPIO_11, N/C) //hoeun aalto
	OMAP3_MUX(JTAG_EMU0,   OMAP_MUX_MODE4|OMAP_PIN_INPUT_PULLDOWN | OMAP_PIN_OFF_INPUT_PULLUP),
	// 302 (W10, H, GPIO_31, VIO_1.8V) - 09/17  //hoeun aalto
	...
	// 303 (AF10, H, GPIO_12, NC)
	OMAP3_MUX(ETK_CLK,	OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	...
	OMAP3_MUX(ETK_D0,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN),
	...
	OMAP3_MUX(ETK_D2,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN), //EXTERNAL PULL-UP
	...
	// 312 (AH14, L, GPIO_21, LCD_ENABLE for Rev0.3 or higher, I[L],// OFF[L])
	OMAP3_MUX(ETK_D7,  OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),
	...
	OMAP3_MUX(ETK_D11, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN), //PULL-UP!!
	// 317 (AG7, L, GPIO_26, HW_REV2)
	OMAP3_MUX(ETK_D12, OMAP_MUX_MODE4 | OMAP_PIN_INPUT),
	// 318 (AC5, L, GPIO_27, JACKNINT(USBSW_INT), HWPULLUP)
	OMAP3_MUX(ETK_D13, OMAP_MUX_MODE4 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	// 319 (AG8, L, GPIO_28, ALS_EN, O[L], OFF[L])
	OMAP3_MUX(ETK_D14,	OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN),
